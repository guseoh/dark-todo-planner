...
export function usePlannerData() {
  ...
  return {
    ...
    deleteTodos: todosState.deleteTodos, toggleTodo: todosState.toggleTodo, archiveTodo: todosState.archiveTodo, unarchiveTodo: todosState.unarchiveTodo,
    ...
    addMemo: memosState.addMemo, updateMemo: memosState.updateMemo, toggleMemoPin: memosState.toggleMemoPin, deleteMemo: memosState.deleteMemo, undoDeleteMemo: memosState.undoDeleteMemo,
