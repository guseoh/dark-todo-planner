...
export type AppView = "dashboard" | "today" | "week" | "month" | "all" | "settings";
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => onChangeView(item.id)}
                className={`flex min-h-14 flex-col items-center justify-center gap-1 rounded-lg text-[11px] font-semibold transition ${
