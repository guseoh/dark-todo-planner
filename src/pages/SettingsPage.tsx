    ...
    <div className="max-w-5xl space-y-6">
      ...
      <section className="app-card p-4 sm:p-5" aria-labelledby="operation-info-title">
        <div className="flex flex-col gap-3 border-b border-ink-700 pb-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className={`inline-flex min-h-9 items-center gap-2 self-start rounded-lg border px-3 py-2 text-xs font-semibold ${connected ? "border-success/40 bg-success/10 text-emerald-100" : "border-danger/50 bg-danger/10 text-red-100"}`} role="status">
        ...
        <dl className="mt-4 grid gap-3 sm:grid-cols-2">
          <div className="rounded-lg border border-ink-700/80 bg-ink-950/40 p-3"><dt className="text-xs font-semibold text-ink-500">사용 모드</dt><dd className="mt-1 text-sm font-bold text-ink-100">단일 사용자</dd></div>
          <div className="rounded-lg border border-ink-700/80 bg-ink-950/40 p-3"><dt className="text-xs font-semibold text-ink-500">저장소</dt><dd className="mt-1 text-sm font-bold text-ink-100">Cloudflare D1</dd></div>
          <div className="rounded-lg border border-ink-700/80 bg-ink-950/40 p-3"><dt className="text-xs font-semibold text-ink-500">하루 시작 시각</dt><dd className="mt-1 text-sm font-bold text-ink-100">오전 3시</dd></div>
          <div className="rounded-lg border border-ink-700/80 bg-ink-950/40 p-3"><dt className="text-xs font-semibold text-ink-500">Discord Todo 알림 예약</dt><dd className="mt-1 text-sm font-bold text-ink-100">매일 오후 9시</dd><p className="mt-1 text-xs text-ink-400">아래 알림 조건을 합쳐 하루 한 번 전송합니다.</p></div>
        </dl>
      </section>
      ...
      <section className="app-card p-4 sm:p-5" aria-labelledby="automation-settings-title">
        ...
        <div className="mt-4 space-y-3">
          <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-ink-700/70 bg-ink-950/35 p-3">
